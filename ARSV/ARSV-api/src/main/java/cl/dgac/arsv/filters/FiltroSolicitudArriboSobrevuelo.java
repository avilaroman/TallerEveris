...
@Named("filtroSolicitudArriboSobrevuelo")
public class FiltroSolicitudArriboSobrevuelo extends FiltroBase<SolicitudArriboSobrevuelo> {
	...
	public FiltroSolicitudArriboSobrevuelo() {
		super();
	}
